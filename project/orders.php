...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> Các sản phẩm đã đặt : <span><?php echo $fetch_orders['total_products']; ?></span> </p>
         <p> Tổng tiền hàng : <span><?php echo $fetch_orders['total_price']; ?>đ</span> </p>
      ...
      <?php
         ...
         echo '<p class="empty">Bạn chưa có đơn hàng đã đặt nào!</p>';
      }
      ?>
   </div>
