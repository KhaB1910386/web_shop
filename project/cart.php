...
<section class="shopping-cart">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="sub-total"> Tổng : <span><?php echo $sub_total = ($fetch_cart['quantity'] * $fetch_cart['price']); ?>vnđ</span> </div>
      </div>
      <?php
   ...
   <div style="margin-top: 2rem; text-align:center;">
      <a href="cart.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled'; ?>" onclick="return confirm('delete all from cart?');">xóa hết</a>
   </div>
