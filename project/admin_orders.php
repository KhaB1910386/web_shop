...
if(isset($_POST['update_order'])){
   ...
   $message[] = 'Tình trạng thanh toán đã được cập nhật!';
...
<section class="orders">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> Tổng các sản phẩm : <span><?php echo $fetch_orders['total_products']; ?></span> </p>
         <p> Tổng giá : <span><?php echo $fetch_orders['total_price']; ?>vnđ</span> </p>
